parcelRequire=function(e,r,t,n){var i,o="function"==typeof parcelRequire&&parcelRequire,u="function"==typeof require&&require;function f(t,n){if(!r[t]){if(!e[t]){var i="function"==typeof parcelRequire&&parcelRequire;if(!n&&i)return i(t,!0);if(o)return o(t,!0);if(u&&"string"==typeof t)return u(t);var c=new Error("Cannot find module '"+t+"'");throw c.code="MODULE_NOT_FOUND",c}p.resolve=function(r){return e[t][1][r]||r},p.cache={};var l=r[t]=new f.Module(t);e[t][0].call(l.exports,p,l,l.exports,this)}return r[t].exports;function p(e){return f(p.resolve(e))}}f.isParcelRequire=!0,f.Module=function(e){this.id=e,this.bundle=f,this.exports={}},f.modules=e,f.cache=r,f.parent=o,f.register=function(r,t){e[r]=[function(e,r){r.exports=t},{}]};for(var c=0;c<t.length;c++)try{f(t[c])}catch(e){i||(i=e)}if(t.length){var l=f(t[t.length-1]);"object"==typeof exports&&"undefined"!=typeof module?module.exports=l:"function"==typeof define&&define.amd?define(function(){return l}):n&&(this[n]=l)}if(parcelRequire=f,i)throw i;return f}({"rSy7":[function(require,module,exports) {
...
},{"./_mapping":"rSy7","./placeholder":"LPQi"}],"Jpv1":[function(require,module,exports) {
...
},{"./_baseIsNative":"iEGD","./_getValue":"Nk5W"}],"N036":[function(require,module,exports) {
var e=require("./_getNative"),r=require("./_root"),a=e(r,"WeakMap");module.exports=a;
},{"./_getNative":"bViC","./_root":"MIhM"}],"qOpS":[function(require,module,exports) {
...
},{"./_baseCreate":"ga8q","./_baseLodash":"YaGB"}],"p0cq":[function(require,module,exports) {
...
},{"./_ListCache":"Xk23","./_stackClear":"y4DG","./_stackDelete":"TpjK","./_stackGet":"skbs","./_stackHas":"ocJ6","./_stackSet":"fwYF"}],"uy4o":[function(require,module,exports) {
...
},{"./_getTag":"tQCT","./isObjectLike":"OuyB"}],"r0rT":[function(require,module,exports) {
...
},{"./_baseMatches":"s6cN","./_baseMatchesProperty":"zCYT","./identity":"Jpv1","./isArray":"p0cq","./property":"mWmH"}],"fWSo":[function(require,module,exports) {
...
},{"./_baseConvert":"gKQw","./_util":"o6Zq"}],"iZ9t":[function(require,module,exports) {
...
},{"./_LodashWrapper":"euOj","./_flatRest":"cbLE","./_getData":"bSg1","./_getFuncName":"ckhT","./isArray":"p0cq","./_isLaziable":"jHmP"}],"u9xe":[function(require,module,exports) {
var e=require("./_createFlow"),r=e();module.exports=r;
},{"./_createFlow":"iZ9t"}],"h3uI":[function(require,module,exports) {
var e=require("./convert"),r=e("flow",require("../flow"));r.placeholder=require("./placeholder"),module.exports=r;
},{"./convert":"qZrs","../flow":"u9xe","./placeholder":"LPQi"}],"Hm7i":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.Api=void 0;var e=t(require("lodash/fp/flow"));function t(e){return e&&e.__esModule?e:{default:e}}function n(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function r(e,t){for(var n=0;n<t.length;n++){var r=t[n];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}function o(e,t,n){return t&&r(e.prototype,t),n&&r(e,n),e}var u=function(){function t(e,r,o){n(this,t),this.defaultRequest={url:"https://api.ongage.net/api",method:"GET",headers:{X_USERNAME:e,X_PASSWORD:r,X_ACCOUNT_CODE:o}}}return o(t,[{key:"compile",value:function(){var t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:[];return(0,e.default)(t)(this.defaultRequest)}}]),t}();exports.Api=u;
},{"lodash/fp/flow":"h3uI"}],"Tdbd":[function(require,module,exports) {
...
},{"./_createBaseFor":"oVe7"}],"FwQQ":[function(require,module,exports) {
var e=require("./isArrayLike"),r=require("./isObjectLike");function i(i){return r(i)&&e(i)}module.exports=i;
},{"./isArrayLike":"LN6c","./isObjectLike":"OuyB"}],"vW3g":[function(require,module,exports) {
...
},{"./_Stack":"I84N","./_assignMergeValue":"Tdbd","./_baseFor":"mduf","./_baseMergeDeep":"XsjK","./isObject":"u9vI","./keysIn":"UACB","./_safeGet":"vW3g"}],"f4Fl":[function(require,module,exports) {
...
},{"./_baseMerge":"WqwZ","./_createAssigner":"gmQJ"}],"HHEV":[function(require,module,exports) {
...
},{"./stringify":"SZfA","./parse":"r1PK","./formats":"mdM2"}],"FOZT":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.put=exports.post=exports.get=exports.list=void 0;var t=r(require("lodash/merge")),e=r(require("qs"));function r(t){return t&&t.__esModule?t:{default:t}}var n=function(e){return function(r){return(0,t.default)({},r,{url:"https://api.ongage.net/".concat(encodeURIComponent(e),"/api")})}};exports.list=n;var o=function(r,n){return function(o){return(0,t.default)({},o,{method:"GET",url:(o.url||"")+r+(n?"?".concat(e.default.stringify(n)):"")})}};exports.get=o;var u=function(e,r){return function(n){return(0,t.default)({},n,{method:"POST",url:(n.url||"")+e,headers:{"Content-Type":"application/json"},body:JSON.stringify(r)})}};exports.post=u;var i=function(e,r){return function(n){return(0,t.default)({},n,{method:"PUT",url:(n.url||"")+e,headers:{"Content-Type":"application/json"},body:JSON.stringify(r)})}};exports.put=i;
},{"lodash/merge":"yubd","qs":"OFf3"}],"DA8m":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.ContactsApi=void 0;var t=require("./Api"),e=require("./utils");function n(t){return(n="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(t){return typeof t}:function(t){return t&&"function"==typeof Symbol&&t.constructor===Symbol&&t!==Symbol.prototype?"symbol":typeof t})(t)}function o(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}function r(t,e){for(var n=0;n<e.length;n++){var o=e[n];o.enumerable=o.enumerable||!1,o.configurable=!0,"value"in o&&(o.writable=!0),Object.defineProperty(t,o.key,o)}}function u(t,e,n){return e&&r(t.prototype,e),n&&r(t,n),t}function c(t,e){if("function"!=typeof e&&null!==e)throw new TypeError("Super expression must either be null or a function");t.prototype=Object.create(e&&e.prototype,{constructor:{value:t,writable:!0,configurable:!0}}),e&&i(t,e)}function i(t,e){return(i=Object.setPrototypeOf||function(t,e){return t.__proto__=e,t})(t,e)}function s(t){var e=p();return function(){var n,o=f(t);if(e){var r=f(this).constructor;n=Reflect.construct(o,arguments,r)}else n=o.apply(this,arguments);return a(this,n)}}function a(t,e){return!e||"object"!==n(e)&&"function"!=typeof e?l(t):e}function l(t){if(void 0===t)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return t}function p(){if("undefined"==typeof Reflect||!Reflect.construct)return!1;if(Reflect.construct.sham)return!1;if("function"==typeof Proxy)return!0;try{return Boolean.prototype.valueOf.call(Reflect.construct(Boolean,[],function(){})),!0}catch(t){return!1}}function f(t){return(f=Object.setPrototypeOf?Object.getPrototypeOf:function(t){return t.__proto__||Object.getPrototypeOf(t)})(t)}var y=function(n){c(i,t.Api);var r=s(i);function i(){return o(this,i),r.apply(this,arguments)}return u(i,[{key:"getById",value:function(t){var n=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null,o=[];return n&&o.push((0,e.list)(n)),o.push((0,e.get)("/contacts/by_id/"+encodeURIComponent(t))),this.compile(o)}},{key:"getByEmail",value:function(t){var n=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null,o=[];return n&&o.push((0,e.list)(n)),o.push((0,e.get)("/contacts/by_email/"+encodeURIComponent(t))),this.compile(o)}},{key:"getListsByEmail",value:function(t){var n=[(0,e.get)("/contacts/cross_account",{email:t})];return this.compile(n)}},{key:"create",value:function(t,n){var o=[];return n&&o.push((0,e.list)(n)),o.push((0,e.post)("/contacts",t)),this.compile(o)}},{key:"update",value:function(t,n){var o=[];return n&&o.push((0,e.list)(n)),o.push((0,e.put)("/contacts",t)),this.compile(o)}},{key:"changeStatus",value:function(t,n){var o=[];return n&&o.push((0,e.list)(n)),o.push((0,e.post)("/v2/contacts/change_status",t)),this.compile(o)}},{key:"changeEmail",value:function(t,n){var o=[];return n&&o.push((0,e.list)(n)),o.push((0,e.post)("/v2/contacts/change_email",t)),this.compile(o)}},{key:"delete",value:function(t,n){var o=[];return n&&o.push((0,e.list)(n)),o.push((0,e.post)("/v2/contacts/delete",t)),this.compile(o)}}]),i}();exports.ContactsApi=y;
},{"./Api":"Hm7i","./utils":"FOZT"}],"Focm":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),Object.defineProperty(exports,"ContactsApi",{enumerable:!0,get:function(){return e.ContactsApi}});var e=require("./ContactsApi");
